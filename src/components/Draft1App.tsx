...
import SiemMonitor from './SiemMonitor';
import CyberSpaceBackground from './CyberSpaceBackground';
...
export default function Draft1App() {
  ...
  return (
    <div className="min-h-screen bg-[#07090e] text-[#b0b9c6] font-sans selection:bg-[#00f3ff]/20 selection:text-[#00f3ff] relative overflow-hidden flex flex-col justify-between">
      ...
      {/* Interactive 3D Cyber space coordinate background */}
      ...
      <div className="w-full max-w-4xl mx-auto px-4 py-8 sm:py-12 z-10 space-y-8">
        ...
        <header className="border border-[#141b2d] bg-[#090d16]/95 p-5 rounded-lg flex flex-col md:flex-row items-start md:items-center justify-between gap-4 backdrop-blur-md relative overflow-hidden animate-fade-in">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="font-mono text-[11px] text-[#00ff66] flex items-center space-x-1.5 pl-0.5">
                      <span className="w-1.5 h-3 bg-[#00ff66]/30 rounded"></span>
                      <span>{exp.role}</span>
                    </div>
